...
declare module paper {
	...
	*/
	export interface PaperSlider  extends Polymer.IronA11yKeysBehavior,Polymer.IronFormElementBehavior,Polymer.PaperInkyFocusBehavior,Polymer.IronRangeBehavior
	{
	/*
	== EVENTS ==
