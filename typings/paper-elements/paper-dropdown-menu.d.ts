...
declare module paper {
	...
	*/
	export interface PaperDropdownMenu  extends Polymer.IronButtonState,Polymer.IronControlState,Polymer.IronFormElementBehavior,Polymer.IronValidatableBehavior
	{
	/*
	== EVENTS ==
