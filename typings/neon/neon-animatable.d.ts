/// <reference path="../neon/NeonAnimatableBehavior.d.ts"/>/// <reference path="../iron/IronResizableBehavior.d.ts"/>
...
declare module neon {
	/* 
		...
		```
	*/
	export class NeonAnimatable  extends Polymer.NeonAnimatableBehavior,Polymer.IronResizableBehavior
	{
